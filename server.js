...
app.get("/info", async (req, res) => {
  ...
  try {
    ...
    // Use the improved ytdl-core with better options
    ...
    if (msg.includes("Status code: 410"))
      return res.status(410).json({ error: "Video no longer available." });
...
app.listen(PORT, () => {
  ...
  console.log(`Using: @distube/ytdl-core (actively maintained fork)`);
});
